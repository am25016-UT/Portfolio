...
### 概要（1〜2行）
神経堤細胞などの**細胞遊走研究**で用いられる「貫通穴アレイを有するシリコーンゴム製ステンシル」について、  
従来法で課題となっている**貫通穴形成の再現性（成功率）**を改善するための**簡易製作プロセス**を提案・開発しています。 :contentReference[oaicite:0]{index=0}

---

### 背景（研究の意義）
神経堤細胞の遊走は神経系・骨格系器官の自己組織的形成において重要であり、  
その機序解明に「貫通穴アレイ構造のステンシル」を用いる手法が注目されています。 :contentReference[oaicite:1]{index=1}  
ステンシルは、基板上の細胞の**初期位置を規定**し、ステンシル除去後に遊走を観察する目的で利用されます。 :contentReference[oaicite:2]{index=2}

---

### 課題（従来法のボトルネック）
従来は、フォトレジスト鋳型上でPDMSをモールディングし、  
未重合PDMSを空気吹き付けで除去して貫通穴を形成しますが、**吹き付け量の調整に高度な手技**が必要です。 :contentReference[oaicite:3]{index=3}  
既報ではステンシル全体での貫通穴形成成功率が **80%程度**に留まる課題があります。 :contentReference[oaicite:4]{index=4}  
また、私自身が従来法を追試したところ、未重合PDMSの完全除去が難しく、成功率は**約6割程度**でした。 :contentReference[oaicite:5]{index=5}

---

### 提案するソリューション（新プロセス）
高度な手技を不要にし、ステンシル全体にわたって貫通穴を形成できるプロセスを目指し、  
**シリコーンゴムチップ＋ガラス基板からなる「流路」を鋳型として用いる手法**を提案しています。 :contentReference[oaicite:6]{index=6}  
流路内部に未重合シリコーンゴムを流し込んで硬化させ、離型後に不要部を切断することで成形します。 :contentReference[oaicite:7]{index=7}

---

### これまでの進捗（できたこと）
- まず従来法でステンシル製作を行い、手技の難しさ（成功率の頭打ち）を定量的に確認しました。 :contentReference[oaicite:8]{index=8}  
- 新プロセスの前段として、**シリコーンゴム製流路を用いた型取りが可能**であることを基礎評価で確認しました。 :contentReference[oaicite:9]{index=9}  
- 流路の鋳型製作プロセスについて、フォトマスク設計〜フォトリソ工程（塗布/ベイク/露光/現像/ポストベイク）を整理し、実装準備を進めています。 :contentReference[oaicite:10]{index=10}

---

### 材料評価（CB-PDMSの細胞毒性）
本研究では、貫通穴ごとに異なる光刺激を与える際に乱反射を抑制する目的で、  
**カーボンナノ粒子混合シリコーンゴム（CB-PDMS）**の利用も検討しています。 :contentReference[oaicite:11]{index=11}  
前期後半に、C2C12細胞を用いた細胞毒性評価を実施し、CB-PDMS片を浮かべた条件でも**細胞増殖への有意差は見られない**ことを確認しました（n=6）。 :contentReference[oaicite:12]{index=12} :contentReference[oaicite:13]{index=13}  

---

### 目標（KPI）
- **貫通穴形成成功率 100%**（ステンシル全体での再現性向上）を目標としています。 :contentReference[oaicite:14]{index=14}  
- 成功率が100%にならない場合は、流路設計の変更などで対策を講じる方針です。 :contentReference[oaicite:15]{index=15}

---

### 評価計画（Validation）
- 従来法ステンシルでの細胞播種→ステンシル除去後の**細胞遊走をタイムラプス観察**します。 :contentReference[oaicite:16]{index=16}  
- 新プロセスにより、貫通穴形成成功率を100%にできるかを評価します。 :contentReference[oaicite:17]{index=17}  
- さらに、蛍光試薬を用いた生死判定により、材料（CB-PDMS）の影響も評価する計画です。 :contentReference[oaicite:18]{index=18}  
- タイムラプスはインキュベーター型顕微鏡（LMV-110, Olympus）を用い、96時間・5分間隔で実施予定（使用方法は習得済み）です。 :contentReference[oaicite:19]{index=19}

---

### 今後の研究計画（ロードマップ）
- ステンシル製作用流路の設計・製作（鋳型用フォトマスク設計、フォトリソで鋳型作製） :contentReference[oaicite:20]{index=20}  
- 鋳型材料として、フォトレジストに加え、**より安価な3Dプリンタ用感光性レジン**が使用可能か検討 :contentReference[oaicite:21]{index=21} :contentReference[oaicite:22]{index=22}  
- 流路プロセスでステンシル成形→成功率評価→（100%達成なら）細胞遊走観察と毒性評価→論文執筆開始 :contentReference[oaicite:23]{index=23}

---

### 論文目標
M1の間に目的を達成できた場合、研究成果をまとめて学術論文を執筆し、  
投稿先として **Lab on a Chip（RSC）**を目標としています。 :contentReference[oaicite:24]{index=24}  
